  ...
  <div class="login">
    <Content :style="{padding: '0 50px', margin: '20px auto'}">
      <Card style="width:450px;margin:0 auto;" dis-hover>
        <Divider class="title">{{ msg }}</Divider>
        <Form ref="formInline" :model="formInline" :rules="ruleInline" :label-width="120">
          ...
          <FormItem prop="password" label="密码">
            <Input type="password" v-model="formInline.password" placeholder="密码" style="width:200px;">
            <Icon type="ios-lock-outline" slot="prepend"></Icon>
            </Input>
          </FormItem>
          <FormItem>
            <Button type="primary" @click="handleSubmit('formInline')" :loading="loading" shape="circle"
              style="width:180px;font-size:14px;">登录</Button>
          </FormItem>
        </Form>
      </Card>
    </Content>
